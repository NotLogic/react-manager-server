  ...
  return (
    <Router>
      <div>
        ...
        <p>
          In modern browsers that suport
          <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/URL">the URL API</a>,you can instantite a 
          <code>URLSearchParams</code> object from
          <code>location.search</code> and use that.
        </p>
        <p>
          In
          <a target="_blank" rel="noopener noreferrer" href="https://caniuse.com/#feat=url">browsers that do not support the URL API</a>
          you can use a 3rd party library such as 
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/sindresorhus/query-string">query-string</a>
        </p>
        <div>
          <h2>Accounts</h2>
          <ul>
            ...
            <li>
              <Link to={{pathname: '/account', search: '?name=modus-create'}}>Modus Create</Link>
            </li>
          </ul>
